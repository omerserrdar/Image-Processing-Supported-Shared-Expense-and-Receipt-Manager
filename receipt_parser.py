"""
PROJE: Market Fisi Veri Ayiklama Sistemi (Parsing) - Yeni Nesil API
ACIKLAMA: PaddleOCR predict() ciktisindaki (dt_polys, rec_texts) yapisini kullanarak
          satirlari birlestiren ve verileri ayiklayan sinif.
"""
...
class ReceiptParser:
    ...
    def parse(self, prediction_result):
        """
        PaddleOCR predict() ciktisini (liste icinde sozluk) alir.
        """
